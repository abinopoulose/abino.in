...
const SOCIAL_LINKS = [
	{
		name: 'GitHub',
		handle: '@abinopoulose',
		url: 'https://github.com/abinopoulose',
	...
	{
		name: 'LinkedIn',
		handle: 'Abino Poulose',
		url: 'https://www.linkedin.com/in/abinopoulose/',
				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:abinopoulose@outlook.com"
